...
# # print(data.dtype)
# print(a)
# print(" another shit shot to know wher eit is executing")
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, '/home/rounak/Documents/trial/models/fruits-model') 
            # saver.save(session, '/home/corse/st119979/Documents/project/new_models/fruits-model')
